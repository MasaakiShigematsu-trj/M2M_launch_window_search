...
# ファイルから結果を読み込み
# data = np.loadtxt("result_E2M/E2M_f1_plot.txt")
# data = np.loadtxt("result_E2M/E2M_f2_plot.txt")
data = np.loadtxt("result_E2M/E2M_f3_plot.txt")
...
levels_TOF = [100, 200, 300, 400, 500, 600]
...
# 各等高線を描画して保存
# plot_contours(vinf1_grid, levels_vinf1, "Earth to Mars : Vinf1", "plots_E2M/Vinf1_E2M_f1.png", "Vinf1 [km/s]")
# plot_contours(C3_grid, levels_C3, "Earth to Mars : C3",          "plots_E2M/C3_E2M_f1.png",    "C3 [km^2/s^2]")
# plot_contours(vinf2_grid, levels_vinf2, "Earth to Mars : Vinf2", "plots_E2M/Vinf2_E2M_f1.png", "Vinf2 [km/s]")

# plot_contours(vinf1_grid, levels_vinf1, "Earth to Mars : Vinf1", "plots_E2M/Vinf1_E2M_f2.png", "Vinf1 [km/s]")
# plot_contours(C3_grid, levels_C3, "Earth to Mars : C3",          "plots_E2M/C3_E2M_f2.png",    "C3 [km^2/s^2]")
# plot_contours(vinf2_grid, levels_vinf2, "Earth to Mars : Vinf2", "plots_E2M/Vinf2_E2M_f2.png", "Vinf2 [km/s]")

plot_contours(vinf1_grid, levels_vinf1, "Earth to Mars : Vinf1", "plots_E2M/Vinf1_E2M_f3.png", "Vinf1 [km/s]")
plot_contours(C3_grid, levels_C3, "Earth to Mars : C3",          "plots_E2M/C3_E2M_f3.png",    "C3 [km^2/s^2]")
plot_contours(vinf2_grid, levels_vinf2, "Earth to Mars : Vinf2", "plots_E2M/Vinf2_E2M_f3.png", "Vinf2 [km/s]")